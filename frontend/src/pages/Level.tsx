...
const LevelPage = () => {
  ...
  const { tasksList, currentLevel, currentTask, isFinished, isError } =
    useSelector((state: AppStateType) => state.LevelReducer);
  const userID = useSelector(
    (state: AppStateType) => state.AuthReducer.tokenUser,
  );
